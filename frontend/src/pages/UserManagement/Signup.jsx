import { Flex, Image, Box, Text, Input, Button, FormControl } from "@chakra-ui/react";
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <PasswordChecklist
            ...
            style={{color: "white"}}
            onChange={(isValid) => {setDisabled(!isValid)}}/>
          <Button colorScheme="teal" variant="outline" isDisabled={disabled} type="submit" mt="4">
            Sign Up
          </Button>
          </FormControl>
        </form>
